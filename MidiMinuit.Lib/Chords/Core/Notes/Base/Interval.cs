...
namespace GuitarChords.Lib.Notes
{
    ...
    {
        public Interval(Note fondamental, Note secondMinor, Note secondMajor, 
            Note secondAugmented, Note thirdMinor, Note thirdMajor,
            Note fourthPerfect, Note fourthAugmented, Note fifthDiminished,
            Note fifthPerfect, Note fifthAugmented, Note sixthMinor,
            Note sixthMajor, Note seventhDiminished, Note seventhMinor,
            Note seventhMajor, Note seventhAugmented)
        {
            if (fondamental       == null) throw new ArgumentNullException(nameof(fondamental));
            if (secondMinor       == null) throw new ArgumentNullException(nameof(secondMinor));
            if (secondMajor       == null) throw new ArgumentNullException(nameof(secondMajor));
            if (secondAugmented   == null) throw new ArgumentNullException(nameof(secondAugmented));
            if (thirdMinor        == null) throw new ArgumentNullException(nameof(thirdMinor));
            if (thirdMajor        == null) throw new ArgumentNullException(nameof(thirdMajor));
            if (fourthPerfect     == null) throw new ArgumentNullException(nameof(fourthPerfect));
            if (fourthAugmented   == null) throw new ArgumentNullException(nameof(fourthAugmented));
            if (fifthDiminished   == null) throw new ArgumentNullException(nameof(fifthDiminished));
            if (fifthPerfect      == null) throw new ArgumentNullException(nameof(fifthPerfect));
            if (fifthAugmented    == null) throw new ArgumentNullException(nameof(fifthAugmented));
            if (sixthMinor        == null) throw new ArgumentNullException(nameof(sixthMinor));
            if (sixthMajor        == null) throw new ArgumentNullException(nameof(sixthMajor));
            if (seventhDiminished == null) throw new ArgumentNullException(nameof(seventhDiminished));
            if (seventhMinor      == null) throw new ArgumentNullException(nameof(seventhMinor));
            if (seventhMajor      == null) throw new ArgumentNullException(nameof(seventhMajor));
            if (seventhAugmented  == null) throw new ArgumentNullException(nameof(seventhAugmented));
        ...
        public Interval(string fondamental, string secondMinor, string secondMajor, string secondAugmented,
            string thirdMinor, string thirdMajor, string fourthPerfect, string fourthAugmented, 
            string fifthDiminished, string fifthPerfect, string fifthAugmented, string sixthMinor,
            string sixthMajor, string seventhDiminished, string seventhMinor, string seventhMajor, string seventhAugmented)
        {
            if (fondamental       == null) throw new ArgumentNullException(nameof(fondamental));
            if (secondMinor       == null) throw new ArgumentNullException(nameof(secondMinor));
            if (secondMajor       == null) throw new ArgumentNullException(nameof(secondMajor));
