...
using GuitarChords.Lib.Extensions;
...
namespace GuitarChords.Lib.Notes
{
    ...
    public class Note : IEquatable<Note>, INotifyPropertyChanged
    {
        ...
        public static Interval GetInterval(Note note)
        {
            ...
            {
                case "C":
                    return new Interval("C", "Db", "D", "D#", "Eb", "E", "F", "F#", "Gb", "G", "G#", "Ab", "A", "Bbb",
                        "Bb", "B", "C");
                case "C#":
                    return new Interval("C#", "D", "D#", "D##", "E", "E#", "F#", "F##", "G", "G#", "G##", "A", "A#",
                        "Bb", "B", "B#", "C#");
                case "Db":
                    return new Interval("Db", "Ebb", "Eb", "E", "Fb", "F", "Gb", "G", "Abb", "Ab", "A", "Bbb", "Bb",
                        "Cbb", "Cb", "C", "Db");
                case "D":
                    return new Interval("D", "Eb", "E", "E#", "F", "F#", "G", "G#", "Ab", "A", "A#", "Bb", "B", "Cb",
                        "C", "C#", "D");
                case "D#":
                    return new Interval("D#", "E", "E#", "E##", "F#", "F##", "G#", "G##", "A", "A#", "A##", "B", "B#",
                        "C", "C#", "C##", "D#");
                case "Eb":
                    return new Interval("Eb", "Fb", "F", "F#", "Gb", "G", "Ab", "A", "Bbb", "Bb", "B", "Cb", "C", "Dbb",
                        "Db", "D", "Eb");
                case "E":
                    return new Interval("E", "F", "F#", "F##", "G", "G#", "A", "A#", "Bb", "B", "B#", "C", "C#", "Db",
                        "D", "D#", "E");
                case "F":
                    return new Interval("F", "Gb", "G", "G#", "Ab", "A", "Bb", "B", "Cb", "C", "C#", "Db", "D", "Ebb",
                        "Eb", "E", "F");
                case "F#":
                    return new Interval("F#", "G", "G#", "G##", "A", "A#", "B", "B#", "C", "C#", "C##", "D", "D#", "Eb",
                        "E", "E#", "F#");
                case "Gb":
                    return new Interval("Gb", "Abb", "Ab", "A", "Bbb", "Bb", "Cb", "C", "Dbb", "Db", "D", "Ebb", "Eb",
                        "Fbb", "Fb", "F", "Gb");
                case "G":
                    return new Interval("G", "Ab", "A", "A#", "Bb", "B", "C", "C#", "Db", "D", "D#", "Eb", "E", "Fb",
                        "F", "F#", "G");
                case "G#":
                    return new Interval("G#", "A", "A#", "A##", "B", "B#", "C#", "C##", "D", "D#", "D##", "E", "E#", "F",
                        "F#", "F##", "G#");
                case "Ab":
                    return new Interval("Ab", "Bbb", "Bb", "B", "Cb", "C", "Db", "D", "Ebb", "Eb", "E", "Fb", "F", "Gbb",
                        "Gb", "G", "Ab");
                case "A":
                    return new Interval("A", "Bb", "B", "B#", "C", "C#", "D", "D#", "Eb", "E", "E#", "F", "F#", "Gb",
                        "G", "G#", "A");
                case "A#":
                    return new Interval("A#", "B", "B#", "B##", "C#", "C##", "D#", "D##", "E", "E#", "E##", "F#", "F##",
                        "G", "G#", "G##", "A#");
                case "Bb":
                    return new Interval("Bb", "Cb", "C", "C#", "Db", "D", "Eb", "E", "Fb", "F", "F#", "Gb", "G", "Abb",
                        "Ab", "A", "Bb");
                case "B":
                    return new Interval("B", "C", "C#", "C##", "D", "D#", "E", "E#", "F", "F#", "F##", "G", "G#", "Ab",
                        "A", "A#", "B");
        ...
        public static Note New(NoteName name = NoteName.C,
        ...
        public Note(NoteName name = NoteName.C,
            NoteAccidental accidental = NoteAccidental.Natural)
        {
            Name = name;
        ...
        //public static bool operator ==(Note left, string right)
        //{
        //    return left == new Note(right);
        //}
        ...
        //public static bool operator ==(string left, Note right)
        //{
        //    return right == left;
        //}
