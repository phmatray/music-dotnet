namespace OpenJam.Music.Core
{
    public partial class Interval
    {
        ...
        public static IntervalDiminishedNinth DiminishedNinth
            => new IntervalDiminishedNinth();
        public static IntervalMinorNinth MinorNinth
            => new IntervalMinorNinth();
        public static IntervalMajorNinth MajorNinth
            => new IntervalMajorNinth();
        public static IntervalAugmentedNinth AugmentedNinth
            => new IntervalAugmentedNinth();

        public static IntervalDiminishedEleventh DiminishedEleventh
            => new IntervalDiminishedEleventh();
        public static IntervalPerfectEleventh PerfectEleventh
            => new IntervalPerfectEleventh();
        public static IntervalAugmentedEleventh AugmentedEleventh
            => new IntervalAugmentedEleventh();

        public static IntervalDiminishedThirteenth DiminishedThirteenth
            => new IntervalDiminishedThirteenth();
        public static IntervalMinorThirteenth MinorThirteenth
            => new IntervalMinorThirteenth();
        public static IntervalMajorThirteeth MajorThirteeth
            => new IntervalMajorThirteeth();
        public static IntervalAugmentedThirteenth AugmentedThirteenth
            => new IntervalAugmentedThirteenth();
    }
}
