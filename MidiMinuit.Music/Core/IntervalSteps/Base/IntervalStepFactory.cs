...
{
    public class IntervalStepFactory
    {
        public virtual List<IntervalStep> CreateAllIntervalNumbers()
        {
        ...
        public virtual IntervalStep CreateIntervalNumber(IntervalStepAlias step)
        {
            switch (step)
            {
